...
interface AlbumSectionProps {
  items?: AlbumItem[];  // ← جعلتها optional
  loading?: boolean;
}
...
export default function AlbumSection({ items = [], loading }: AlbumSectionProps) {
  ...
  // تأكد من أن items دائماً مصفوفة
  ...
  const selectedImageUrl = selectedImage ? getPublicImageUrl('seller-album', selectedImage.image_url) : null;
